...
{
    public class EntretenimientoDetailViewModel : BaseViewModel
    {
        public LugarItem Lugar { get; set; }

        public EntretenimientoDetailViewModel()
        {
            Title = "Entretenimiento";
        }

        public EntretenimientoDetailViewModel(LugarItem lugarItem = null)
        {
            Title = "Entretenimiento";
