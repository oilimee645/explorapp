...
namespace ExplorAppTeo.Views
{
    ...
    public partial class HotelesPage : ContentPage
    {
        ...
        protected async override void OnAppearing()
        {
            ...
            LugaresListView.ItemsSource = await App.Database.GetCatalogoLugarItems("Hoteles");
        }
        ...
        private async void OnListItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            ...
            await Navigation.PushAsync(new HotelesDetailPage(new HotelesDetailViewModel(item)));
